...
<link rel="stylesheet" href="<?php $this->options->themeUrl('css/app.css') ?>" type="text/css" />-->
    ...
    <!-- 本地compass版本 -->
    <link rel="stylesheet" href="<?= THEME_URL ?>/css/appall.css" type="text/css" />
    <link rel="stylesheet" href="<?= THEME_URL ?>/packages/OwO/OwO.css" type="text/css" />
    <script src="<?= THEME_URL ?>/packages/OwO/OwO.min.js"></script>
    ...
    <style type="text/css">
        ...
        <?php if ($this->options->progresscolor): ?>
            #instantclick-bar {
                background:
                    <?php $this->options->progresscolor() ?>
                    !important;
            }
        ...
        html.bg {
            ...
            <?php elseif ($this->options->BGtype == '2'): ?>
                ...
                <?php elseif ($this->options->GradientType == '5'): ?>
                    background-image: #DAD299;
                    /* fallback for old browsers */
                    background-image: -webkit-linear-gradient(to left, #DAD299, #B0DAB9);
                    /* Chrome 10-25, Safari 5.1-6 */
                    background-image: linear-gradient(to left, #DAD299, #B0DAB9);
